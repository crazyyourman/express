...
<html>
<head>
    <title>全球在线-后台管理系统</title>
	<meta charset="UTF-8">
   <link rel="stylesheet" type="text/css" href="jsp/manage/Css/bootstrap.css" />
    <link rel="stylesheet" type="text/css" href="jsp/manage/Css/bootstrap-responsive.css" />
...
<div class="container">
    ...
    <form class="form-signin" method="post" action="manage?login">
        <h2 class="form-signin-heading">管理登录系统</h2>
